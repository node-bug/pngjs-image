...
Chunk.addChunkType = function (type, module) {
	...
	// Add utils
	utils.loadModule(require('./utils/chunkUtils.js'), module);
...
Chunk.initDefaultChunkTypes = function () {
	var chunks = {
		bKGD: require('./chunks/bKGD'),
		cHRM: require('./chunks/cHRM'),
		gAMA: require('./chunks/gAMA'),
		hIST: require('./chunks/hIST'),
		iCCP: require('./chunks/iCCP'),
		IDAT: require('./chunks/IDAT'),
		IEND: require('./chunks/IEND'),
		IHDR: require('./chunks/IHDR'),
		pHYs: require('./chunks/pHYs'),
		PLTE: require('./chunks/PLTE'),
		sRGB: require('./chunks/sRGB'),
		tEXt: require('./chunks/tEXt'),
		tIME: require('./chunks/tIME'),
		tRNS: require('./chunks/tRNS'),
		zTXt: require('./chunks/zTXt'),
		oFFs: require('./chunks/oFFs'),
		sCAL: require('./chunks/sCAL'),
		sTER: require('./chunks/sTER'),
	};

	Object.entries(chunks).forEach(function ([chunkType, module]) {
...
Chunk.initCustomChunkTypes = function () {
	var chunks = {
		stRT: require('./custom/stRT'),
		jsOn: require('./custom/jsOn'),
		zzZz: require('./custom/zzZz'),
	};
